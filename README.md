...
3. Find your SPREADSHEET_ID from the Google Sheets link. Example:<br>h<span>ttps://docs.goo</span>gle.com/spreadsheets/d/**SPREADSHEET_ID**/edit?gid=0#gid=0
4. Paste your SPREADSHEET_ID into the **credentials.py**: `SPREADSHEET_ID = ''`